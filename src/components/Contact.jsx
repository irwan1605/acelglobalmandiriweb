...
export default function Contact({
  companyName = "PT. Acel Global Mandiri",
  address = "Jl. Barito Raya No.176, Bakti Jaya, Kec. Sukmajaya, Kota Depok, Jawa Barat 16418 ",
  mapUrl = "https://maps.app.goo.gl/oyr9oYLcpXFLfrmf7?q=Jl. Barito Raya No.176, RW.15, Abadijaya, Kec. Sukmajaya, Kota Depok, Jawa Barat",
  mapEmbedUrl, // opsional: jika tak disediakan, dibuat otomatis dari address
  email = "acelmandiriglobal.id",
  phone = "+62 813 7388 7889",
